...
import com.study.responsebean.SimpleResponse;
import com.study.utils.Convert;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != CommentResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                CommentResponse commentResponse = Convert.fromJson(jsonReader, type);
                response.close();
                String code = commentResponse.code;
                ...
                if ("200".equals(code)) {
                    ...
                    throw new IllegalStateException("错误代码：" + code + "，错误信息：" + commentResponse.message);
                }
            }
        }
    }
